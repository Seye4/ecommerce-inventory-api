...
const getAllProducts = (...args_1) => __awaiter(void 0, [...args_1], void 0, function* (searchTerm = "") {
...
const deleteProductInDB = (productId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.Product.findByIdAndDelete(productId);
    return result;
});
exports.ProductServices = { createAProductIntoDB, getAllProducts, getSingleProductFromDB, updateProductIntoDB, deleteProductInDB };
